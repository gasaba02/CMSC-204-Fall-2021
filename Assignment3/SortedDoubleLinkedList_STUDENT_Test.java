...
public class SortedDoubleLinkedList_STUDENT_Test {
	...
	public Car a=new Car("Ferrari", "Italia", 2005);
	public Car b=new Car("Jaguar", "Ftype", 2005);
	public Car c=new Car("Hyundai", "Tucson", 2005);
	public Car d=new Car("Scion", "Frs", 2005);
	public Car e=new Car("Cadilac", "Escalade", 2005);
	public Car f=new Car("Chevrolet", "Impala", 2005);
	...
	public void testAddToEnd() {
		try {
			sortedLinkedString.addToEnd("Howdy");
	...
	public void testAddToFront() {
		try {
			sortedLinkedString.addToFront("Howdy");
			assertTrue("Did not throw an UnsupportedOperationException", false);
		}
		catch (UnsupportedOperationException e)
		{
	...
	public void testIteratorSuccessfulStringPrevious() {
		sortedLinkedString.add("Boy");
		sortedLinkedString.add("Woman");
		sortedLinkedString.add("Howdy");
		sortedLinkedString.add("Zzzz");
		ListIterator<String> iterator = sortedLinkedString.iterator();
		assertEquals(true, iterator.hasNext());
		assertEquals("Boy", iterator.next());
		assertEquals("Howdy", iterator.next());
		assertEquals("Woman", iterator.next());
		assertEquals("Zzzz", iterator.next());
		assertEquals(true, iterator.hasPrevious());
		assertEquals("Zzzz", iterator.previous());
		assertEquals("Woman", iterator.previous());
		assertEquals("Howdy", iterator.previous());
	}
	@Test
