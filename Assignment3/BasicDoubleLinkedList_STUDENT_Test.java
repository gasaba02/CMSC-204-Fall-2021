...
public class BasicDoubleLinkedList_STUDENT_Test{
	...
	public Car a=new Car("Ford", "fusion", 2005);
	public Car b=new Car("Mazda", "Cx5", 2005);
	public Car c=new Car("Honda", "Passport", 2005);
	public Car d=new Car("Lexus", "Rx350", 2005);
	public Car e=new Car("Cadilac", "Xt5", 2005);
	public Car f=new Car("Audi", "A4", 2005);
	...
	public void testAddToEnd() {
		assertEquals("Partner", linkedString.getLast());
	...
	public void testIteratorSuccessfulNext() {
		...
		assertEquals("Partner", iterator.next());
		assertEquals(true, iterator.hasNext());
	...
	public void testRetrieveFirstElement() {
		...
		assertEquals("Partner",linkedString.getFirst());
