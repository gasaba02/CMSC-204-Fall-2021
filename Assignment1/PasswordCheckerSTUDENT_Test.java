...
public class PasswordCheckerSTUDENT_Test {
	...
	public void setUp() throws Exception {
		String[] myPasswords = {"infinitywar03#", "Starwars33", "iron", "CR7RONALDO!", "AAAaaok!34"};
	...
	public void testInvalidPasswords() {
		...
		assertEquals(myResult.size(), 5);
		assertEquals(myResult.get(1), "Starwars33 -> The password must contain at least one special character");
		assertEquals(myResult.get(0), "infinitywar03# -> The password must contain at least one uppercase alphabetic character");
		assertEquals(myResult.get(2), "iron -> The password must be at least 6 characters long");
		assertEquals(myResult.get(3), "CR7RONALDO! -> The password must contain at least one lower case alphabetic character");
		assertEquals(myResult.get(4), "AAAaaok!34 -> The password cannot contain more than two of the same character in sequence");
